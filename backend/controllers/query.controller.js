...
`;
    ...
    const watchdogVerdict = parseVerdict(watchdogResult.response.text());
    const factVerdict = parseVerdict(factResult.response.text());
    const studentVerdict = parseVerdict(studentResult.response.text());
